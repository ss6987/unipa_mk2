...
('F321', 'Entity.User authorization', '', '', 'YES', NULL, ''),
...
('S211', 'Entity.User-defined cast functions', '', '', 'NO', NULL, ''),
...
('S251', 'Entity.User-defined orderings', '', '', 'NO', NULL, ''),
...
('T321', 'Basic SQL-invoked routines', '01', 'Entity.User-defined functions with no overloading', 'YES', NULL, ''),
('T321', 'Basic SQL-invoked routines', '02', 'Entity.User-defined stored procedures with no overloading', 'YES', NULL, ''),
...
( 18, 'DBMS VERSION', NULL, '2.4.1', 'CHAR: Version of the implementation software The format is: <part1>.<part2>.<part3>[<part4>] where: <part1> ::= <digit><digit> <part2> ::= <digit><digit> <part3> ::= <digit><digit><digit><digit> <part4> ::= <character representation>' ),

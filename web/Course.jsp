...
<%
    ...
    String  fulltani = (String) session.getAttribute(" fulltani");
...
<table BORDER="1" align="right" >
    <tr align="center"><td>単位合計</td><td><%=fulltani%></td></tr>
</table>
<br>
<button type="submit" name="coursnext" align="center">戻る</button>
<button type="submit" name="coursnext" align="center">確定</button>

    ...
    <form action="/Main" method="post">
        <table border="1">
            <tr>
                ...
                <td>
                    <div>
                        西暦<input type="text" name="startYear" value="<%=startDate.getYear()%>" required
                                 pattern="^20[0-9][0-9]$">年
                        <input type="text" name="startMonth" value="<%=startDate.getMonthValue()%>" required
                               pattern="^(1[0-2]|[1-9])$">月
                        <input type="text" name="startDay" value="<%=startDate.getDayOfMonth()%>" required
                               pattern="^([1-9]|1[0-9]|2[0-9]|3[01])$">日
                    </div>
                    <div>~</div>
                    <div>
        ...
        <button type="submit" name="action" value="PeriodRegistrationDone">登録</button>
    </form>
</div>
</body>
</html>
...
<form action="/Main" method="post">
    <button type="submit" class="btn_1" name="action" value="UserDetail">もどる</button>
</form>
<form action="/Main" method="post">
    <button type="submit" name="action" class="btn_3" value="UserDeleteDone" align="center"> 削除</button>
</form>
</body>
</html>

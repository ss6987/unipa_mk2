            ...
            <form action="/Main" method="post" name="userRegistration">
                <table BORDER="1" align="center">
                    ...
                    <tr align="center">
                        ...
                        <td>
                            ...
                            <input type="text" name="targetUserId"
                                   value="<jsp:getProperty name="targetUser" property="userId" />" required
                                   pattern="^[0-9A-Za-z]+$" tabindex="1"/>
                            <%
                            } else {
                            %>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <input type="text" name="phonetic"
                                   value="<jsp:getProperty name="targetUser" property="phonetic"/>" required
                                   pattern="^[ァ-ヶー　 ]+$" tabindex="3"/>
                        </td>
                    </tr>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <input type="radio" name="gender" value="0"
                                   tabindex="5" <%=targetUser.getGenderSelected(0)%>>男性
                            <input type="radio" name="gender" value="1"
                                   tabindex="6" <%=targetUser.getGenderSelected(1)%>>女性
                        </td>
                    </tr>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            西暦<input type="text" name="year"
                                     value="<jsp:getProperty name="targetUser" property="birthYear"/>" required
                                     pattern="^[0-9]+$" tabindex="7"/>年
                            <input type="text" name="month"
                                   value="<jsp:getProperty name="targetUser" property="birthMonth"/>" required
                                   pattern="^[0-9]+$" tabindex="8"/>月
                            <input type="text" name="day"
                                   value="<jsp:getProperty name="targetUser" property="birthDay"/>" required
                                   pattern="^[0-9]+$" tabindex="9"/>日
                        </td>
                    </tr>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <input type="text" name="postal_code"
                                   value="<jsp:getProperty name="targetUser" property="postalCode"/>" required
                                   pattern="^[0-9]{7}" tabindex="10"/><br>※ハイフンなしで入力
                        </td>
                    </tr>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <input type="text" name="address"
                                   value="<jsp:getProperty name="targetUser" property="address"/>" tabindex="11"
                                   required/>
                        </td>
                    </tr>
                    ...
                    <tr align="center">
                        <th>電話番号</th>
                        <td>
                            <input type="text" name="tel" value="<jsp:getProperty name="targetUser" property="tel"/>"
                                   required pattern="^[0-9]{10,11}" tabindex="12"/><br>※ハイフンなしで入力
                        </td>
                    </tr>
                ...
                <%
                    if (!targetUserId.equals("")) {
                %>
                <button type="submit" name="action" value="UserUpdateDone" class="btn_4" align="center" tabindex="15">
                    更新
                </button>
                <button type="submit" name="action" value="UserDelete" class="btn_3" align="center" tabindex="16"> 削除
                </button>
                <%
                } else {
                %>
